...
def sqlite_list_tables(database_path: Optional[str] = None) -> Dict[str, Any]:
    """
...
def sqlite_create_sample_database(database_path: Optional[str] = None) -> Dict[str, Any]:
    """
