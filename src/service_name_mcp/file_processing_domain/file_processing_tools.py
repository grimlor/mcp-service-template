        ...
        if headers and rows:
            for row in rows:
                if len(row) == len(headers):
                    analysis["data"].append(dict(zip(headers, row)))
                else:
...
def analyze_csv_columns(data: List[Dict], headers: Optional[List[str]]) -> Dict[str, Any]:
...
def analyze_json_structure(data: Any, max_depth: int = 5) -> Dict[str, Any]:
    ...
    def get_structure(obj, depth=0):
        ...
        if isinstance(obj, dict):
            ...
            return {
                ...
                "all_same_type": len(set(type(item).__name__ for item in obj)) == 1
            }
        else:
    ...
    return {
        ...
        "size_estimate": estimate_json_size(data)
    }
...
def create_sample_files(
    output_directory: str = "./sample_data"
) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        csv_data = [
            {"customer_id": 1, "name": "Alice Johnson", "email": "alice@example.com", "age": 29, "city": "New York", "purchase_amount": 156.78},
            {"customer_id": 2, "name": "Bob Smith", "email": "bob@example.com", "age": 35, "city": "Los Angeles", "purchase_amount": 89.99},
            {"customer_id": 3, "name": "Carol Davis", "email": "carol@example.com", "age": 42, "city": "Chicago", "purchase_amount": 234.56},
            {"customer_id": 4, "name": "David Wilson", "email": "david@example.com", "age": 28, "city": "Houston", "purchase_amount": 45.00},
            {"customer_id": 5, "name": "Eva Brown", "email": "eva@example.com", "age": 31, "city": "Phoenix", "purchase_amount": 378.90}
        ]
...
2024-01-15 12:30:00 WARN High memory usage detected: 87%"""
        ...
        tsv_data = [
            {"product_id": "P001", "category": "Electronics", "sales_q1": "15000", "sales_q2": "18000", "sales_q3": "22000", "sales_q4": "25000"},
            {"product_id": "P002", "category": "Books", "sales_q1": "8000", "sales_q2": "7500", "sales_q3": "9000", "sales_q4": "12000"},
            {"product_id": "P003", "category": "Electronics", "sales_q1": "12000", "sales_q2": "14000", "sales_q3": "16000", "sales_q4": "19000"},
            {"product_id": "P004", "category": "Home", "sales_q1": "5000", "sales_q2": "6000", "sales_q3": "7500", "sales_q4": "9000"}
        ]
